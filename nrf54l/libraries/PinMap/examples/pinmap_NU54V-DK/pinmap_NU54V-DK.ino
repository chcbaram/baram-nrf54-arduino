 ...
 **어느 핀이냐보다 어느 포트냐가 먼저 정해진다.**
 ...
 P2 헤더 (30핀)
   ...
   --- ------ ---------------- ------------------------------ --- --- ---- ----------------------------------
     9 P1.07  A3 / Serial1 CTS PIN_A3, PIN_SERIAL1_CTS, A3    o   o   AIN3 SAADC.AIN3, TAMPC.ASI[1]
    10 P1.06  A2 / Serial1 RTS PIN_A2, PIN_SERIAL1_RTS, A2    o   o   AIN2 SAADC.AIN2, TAMPC.ASO[1]
    11 P1.05  A1 / Serial1 RX  PIN_A1, PIN_SERIAL1_RX, A1     o   o   AIN1 RADIO.RADIO[6], SAADC.AIN1, TAMPC.ASI[0]
    12 P1.04  A0 / Serial1 TX  PIN_A0, PIN_SERIAL1_TX, A0     o   o   AIN0 SAADC.AIN0, TAMPC.ASO[0]
    16 P1.08  SW3              PIN_BUTTON3                    o   o   x    SAADC.EXTREF, GRTC.CLK16M
    17 P2.04  SPI MISO         PIN_SPI_MISO, MISO             x   x   x    SPIM/SPIS00.SDI, UARTE00.CTS, SPIM/SPIS20.SDI, UARTE20.CTS, sQSPI.D1
    19 P2.05  SPI SS           SS                             x   x   x    SPIM/SPIS00.CS, UARTE00.RTS, SPIM/SPIS20.CS, UARTE20.RTS, sQSPI.CSN
    ...
    22 P2.08  PMIC PG          PIN_PMIC_PG                    x   x   x    SPIM/SPIS00.SDO, UARTE00.TXD, SPIM/SPIS21.SDO, UARTE21.TXD
    23 P2.09  LED1             PIN_LED1, LED_BUILTIN, LED_RED x   x   x    SPIM/SPIS00.SDI, UARTE00.CTS, SPIM/SPIS21.SDI, UARTE21.CTS
    24 P2.10  PMIC CE          PIN_PMIC_CE                    x   x   x    SPIM/SPIS00.CS, UARTE00.RTS, SPIM/SPIS21.CS, UARTE21.RTS
 ...
 P4 헤더 (30핀)
   ...
   --- ------ ------------- ---------------------------- --- --- ---- ----------------------------------
     ...
     9 P1.11  A4 / PMIC INT PIN_A4, PIN_PMIC_INT, A4     o   o   AIN4 RADIO.RADIO[2], SAADC.AIN4, TAMPC.ASO[3]
    10 P1.12  A5 / VBAT_MON PIN_A5, PIN_VBAT, A5         o   o   AIN5 RADIO.RADIO[3], SAADC.AIN5, TAMPC.ASI[3]
    ...
    20 P2.01  SPI SCK       PIN_SPI_SCK, SCK             x   x   x    SPIM/SPIS00.SCK, SPIM/SPIS20.SCK, sQSPI.SCK
    21 P2.02  SPI MOSI      PIN_SPI_MOSI, MOSI           x   x   x    SPIM/SPIS00.SDO, UARTE00.TXD, SPIM/SPIS20.SDO, UARTE20.TXD, sQSPI.D0
...
void setup()
{
  ...
  Serial.println("NU54V-DK pin map (nRF54L15)");
