...
| 메모리 배치 | NU54V-DK 와 동일 → [MEMORY-MAP.md](../MEMORY-MAP.ko.md) 의 nRF54L15 절 |
...
P1 이 도메인 20 이기 때문이다 ([PERIPHERAL-PINMAP.md](../PERIPHERAL-PINMAP.ko.md)).
...
> 명시한다 ([PERIPHERAL-PINMAP.md](../PERIPHERAL-PINMAP.ko.md) §1·§4).
